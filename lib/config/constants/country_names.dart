const Map<String, Map<String, String>> countryNames = {
  ...
  "BM": {"es": "Bermuda", "en": "Bermuda"},
  "BT": {"es": "Bután", "en": "Bhutan"},
  "BO": {"es": "Bolivia", "en": "Bolivia"},
  "BQ": {"es": "Caribe Neerlandés", "en": "Caribbean Netherlands"},
  ...
  "NU": {"es": "Niue", "en": "Niue"},
  "NF": {"es": "Islas Norfolk", "en": "Norfolk Island"},
  ...
  "ST": {"es": "Santo Tomé y Principe", "en": "Sao Tome and Principe"},
  "SA": {"es": "Arabia Saudi", "en": "Saudi Arabia"},
  ...
  "SX": {"es": "San Martín", "en": "Sint Maarten"},
